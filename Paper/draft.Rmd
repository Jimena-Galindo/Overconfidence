...
After observing the outcome of each gamble, the agent updates their beliefs of both theta and omega in one of 4 differente ways: 
...
However, under the assumption that the agent is myopic, the choices might not gererate sufficient variation in effort to 
...
of their choices with the exogenous state are such that the data observed is consistent with the erroneous beliefs. Each of 
the updating mecahnisms above will make different predicitons about the cases in which the agent is able to learn their true 
