...
framework with endogenous information and two complementary
fundamentals: an ego-relevant parameter and a state. Within this
framework I study three forces that can lead to misspecified beliefs:
dogmatism, learning traps and biased updating. I find that biased
updating is the main driver of misspecifications. In addition, I vary
the degree of ego-relevance of the parameter by introducing a stereotype
treatment. The data is consistent with biased updating in both cases but
for potentially different reasons: subjects attribute successes to their
own ability and failures to luck. In the stereotype treatment they
over-compensate for initial negative biases by over-attributing positive
signals to the ability of others. This translates into similar observed
choices but different dynamisc in beliefs.
\end{abstract}
...
the information they acquire is influenced by their actions and their
subsequent behavior is in turn determined by how they incorporate the
information into their beliefs. This further affects the information
generating process.

Consider a student who needs to decide how much effort to put into
studying for an exam. Their decision will depend on two different
factors: their belief about their intrinsic ability, and their belief
about how difficult the exam will be. The outcome that they observe will
be affected by how much they decide to study. Imagine that the student
puts in a moderate amout of effort and gets a surprisingly good grade.
...
reasoning they take; in turn, their performance in the next exam will
further affect the outcome they observe. This type of feedback loop is
what I call and \emph{endogenous information 
setting} and is at the center of the forces that I study.
...
misspecified beliefs. To do so, I first come up with a unifying
framework in which each of the theories makes different predictions. I
then implement this framework in a laboratory experiment. The framework
that I use features an agent who, in order to make optimal decisions,
needs to learn a parameter that regards their own characteristics (an
\emph{ego-relevant} parameter), as well as an exogenously determined
state---in the case of the student it would be their intrinsic ability
and the difficulty of the exam.

Misspecified beliefs about an ego-relevant parameter are often referred
to as overconfidence and have been documented by behavioral
science\footnote{\citet{kelley1980} 
provides a review of the psychology literature.} and
economics\footnote{See \citet{benjamin2019} 
...
make retirement decisions as if they were. \citet{Hoffman2020} show that
workers overestimate the quality of their match to their current
employment and are unlikely to look for other opportunities.
...
The goal is primarily to identify the which of the 3 forces---dogmatism,
the presence of learning traps or missatribution bias---better explains
the observed behavior. To do so, I compare the behavior predicted by
each theory to the benchmark given by the fully Bayesian updating
procedure.

On a secondary level, I also aim to understand if the misspecification
is inherently linked to the ego-relevance of one of the parameters or if
it is a more general phenomenon. To do so I vary the degree of
ego-relevance by introducing a treatment in which subjects learn about
the ability of another participant. In this treatment, the participants
know only the gender and nationality of the other, which can induce
stereotypes---a different type of misspecification.\\
...
I find that, although some agents do fall into learning traps, the
...
Finally, I structurally estimate the parameters of the models to study
heterogeneity in the sample. I find that even at an individual level the
behavior is better explained by misattribution bias for most subjects.
There is a smaller group of subjects that can be better explained
through dogmatic beliefs and hypothesis testing and none of them behave
