...
\begin{frame}{Misspecified Learning}
    May aspects of behavior depend on learning from data about a fundamental\\
    \bigskip
    There is mounting research documenting incorrect learning\\
    \bigskip
    I focus on 3 drivers of incorrect learning:
    \begin{enumerate}
        \item Misspecified initial beliefs
        \item Incorrect updating procedure
        \item Learning traps
    \end(enumerate)
