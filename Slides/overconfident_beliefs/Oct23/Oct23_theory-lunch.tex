...
\begin{frame}{Questions}
    Which of the theories better explains the observed behavior? \\
    \begin{itemize}
        \item Do we observe heterogeneity in the use of misspecified models? 
    \end{itemize}
    \bigskip
...
\begin{frame}{An Example}
    ...
    \bigskip
    Effort and ability are evaluated by a \taxtbf{grading system} $\omega$ (\alert{exogenous parameter})\\
    \bigskip 
...
\begin{frame}{The Self-Defeating Equilibria}
...
\begin{frame}{The Stereotypes}
    \begin{figure}
        \centering
        \includegraphics[scale=.33]{believed_actual_type_heat.png}
    \end{figure}
...
\begin{frame}{Identification of $\alpha$}
    ...
    to be $\alpha $\\
    \bigskip
    I find $\alpha=1.5$ and no difference across treatments\\
...
\begin{itemize}
    \item Data is not fully consistent with the model
    \item Some indications of self-attribution bias
    \item Fit os Switching is better overall
...
\begin{frame}{What is Next}
    \begin{enumerate}
        ...
        \end{itemize}
        \item Can the behavior be explained by a model with forward-looking agents?
        \begin{itemize}
