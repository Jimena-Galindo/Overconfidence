...
\title{Learning with Misspecified Models:\\  overconfidence and stereotypes}
...
\begin{frame}{Motivation}
    Updating beliefs is a difficult task\\
    \bigskip
    Mounting evidence of biases\\
\documentclass[aspectratio=169]{beamer}
...
\begin{frame}{Motivation}
    ...
    Mounting evidence of biases\\
    \bigskip
    Economic theory developed models that rationalize biased behaviors
\end{frame}
